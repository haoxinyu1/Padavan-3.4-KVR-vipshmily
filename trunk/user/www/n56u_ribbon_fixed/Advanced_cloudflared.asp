										...
										<div class="row-fluid">
											...
											<div id="wnd_cloudflared_cfg">
												<div class="alert alert-info" style="margin: 10px;">
													...
													<div>打开【<a href="https://one.dash.cloudflare.com/"
															target="blank">官网</a>】进入Zero Trust创建或管理您的 cloudflared
														隧道。&nbsp;&nbsp;<a
															href="https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/install-and-setup/tunnel-guide/local/"
															target="blank">官方文档</a></div>
													<div>当前版本:【<span style="color: #FFFF00;">
															<% nvram_get_x("", "cloudflared_ver" ); %>
														</span>】&nbsp;&nbsp;最新版本:【<span style="color: #FD0187;">
															<% nvram_get_x("", "cloudflared_ver_n" ); %>
														</span>】</div>
												</div>
													...
													<tr>
														...
														<td>
															<div class="main_itoggle">
																<div id="cloudflared_enable_on_of">
																	<input type="checkbox" id="cloudflared_enable_fake"
																		<% nvram_match_x("", "cloudflared_enable" , "1"
																		, "value=1 checked" ); %>
																	<% nvram_match_x("", "cloudflared_enable" , "0"
																		, "value=0" ); %> />
																</div>
															</div>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="cloudflared_enable"
																	id="cloudflared_enable_1" class="input" value="1"
																	onClick="change_cloudflared_enable(1);" <%
																	nvram_match_x("", "cloudflared_enable" , "1"
																	, "checked" ); %> /><#checkbox_Yes#>
																	<input type="radio" value="0"
																		name="cloudflared_enable"
																		id="cloudflared_enable_0" class="input"
																		value="0"
																		onClick="change_cloudflared_enable(1);" <%
																		nvram_match_x("", "cloudflared_enable" , "0"
																		, "checked" ); %> /><#checkbox_No#>
														...
														<td colspan="3">
															<input class="btn btn-success" style="width:150px"
																type="button" name="updatecloudflared" value="更新"
																onclick="button_updatecloudflared()" />
														</td>
													</tr>
													<td colspan="3"></td>
													<tr>
														...
														<td style="border-top: 0 none;" colspan="3">
															<div class="input-append">
																<textarea maxlength="2024" class="input"
																	name="cloudflared_cmd" id="cloudflared_cmd"
																	placeholder="tunnel --no-autoupdate --loglevel info --logfile /tmp/cloudflared.log run --token eyJh开头的token"
																	style="width: 300px; height: 30px; resize: both; overflow: auto;"><% nvram_get_x("","cloudflared_cmd"); %></textarea>
															</div><span
																style="color:#888;">不需要加程序路径和程序名，直接填写启动参数即可。<br>如需日志请指定<span
																	style="color: yellow;">--logfile
																	/tmp/cloudflared.log</span> &nbsp;&nbsp;<a
																	href="https://www.toutiao.com/video/7185909714687885858/"
																	target="blank">教程</a></span>
														</td>
													</tr>
													<td colspan="3"></td>
													<tr>
														...
														<td colspan="3" style="border-top: 0 none;">
															<div class="input-append">
																<textarea maxlength="1024" class="input"
																	name="cloudflared_bin" id="cloudflared_bin"
																	placeholder="/etc/storage/bin/cloudflared"
																	style="width: 300px; height: 20px; resize: both; overflow: auto;"><% nvram_get_x("","cloudflared_bin"); %></textarea>
															</div><span
																style="color:#888;">指定cloudflared程序路径和程序名,程序下载地址：<a
																	href="https://wwf.lanpv.com/b05evijeh"
																	target="blank">点此下载</a>&nbsp;&nbsp;密码8267</span>
														</td>
													</tr>
													<tr>
														<td colspan="4">
											...
											<tr>
												<td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
													<textarea rows="21" class="span12"
														...
														id="textarea"><% nvram_dump("cloudflared.log",""); %></textarea>
												</td>
											</tr>
											<tr>
